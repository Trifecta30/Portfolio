//based off river rocks challenge
angleMode = "radians";
...
Repeller.prototype.display = function() {
    image(getImage("avatars/aqualine-ultimate"), this.position.x, this.position.y-50, 60, 80);
};
...
Particle.prototype.display = function() {
    ...
    image(getImage("avatars/marcimus-orange"), this.position.x, this.position.y, 12, 12);
...
var repellers=[];
for(var i=0;i<3;i++){
    repellers.push(new Repeller(random(0,400),random(100,300)));
}

mouseClicked = function() {
    repellers.push(new Repeller(mouseX-30, mouseY));
};
